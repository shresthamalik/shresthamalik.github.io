...
portfolioAppModule.controller("portfolioController",function($scope){
  ...
  $scope.projects = [
    ...
    link:'https://github.com/shresthamalik/FacialExpressionRecognition',
    ...
    {name:'Weather App', 
    source:'Free Code Camp', period:"Aug '16",
    link:'http://codepen.io/sMalik/full/RGVLAA/',
    ...
    'It also displays the current location on map '+
    'You can also enter the city name to find the weather there',
    imageSrc: 'https://farm9.staticflickr.com/8342/29349982843_5483f5d1d4_b.jpg'
    },
    
    //Proj 4
    {name:'Website', 
    source:'', period:"Ongoing",
    link:'https://github.com/shresthamalik/shresthamalik.github.io',
    desc:'I developed this website using JavaScript, AngularJs, HTML, CSS and Bootstrap. ' +
    'The charts were made using chartjs. Click to see the git hub code. ',
    imageSrc: 'https://farm6.staticflickr.com/5315/29899304152_caeac6a251_c.jpg'
    },
